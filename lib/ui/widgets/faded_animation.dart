...
class FadeAnimation extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    //   ..add(AniPros.translateY, (-30.0).tweenTo(0.0), 500.milliseconds,
    //       Curves.easeOut);
    final tween = MultiTween<AniPros>()
      ..add(AniPros.opacity, Tween(begin: 0.0, end: 1.0),
          const Duration(milliseconds: 500))
      ..add(AniPros.translateY, Tween(begin: -30.0, end: 0.0));
    return PlayAnimation<MultiTweenValues<AniPros>>(
      ...
      builder: (context, child, value) => Opacity(
        ...
        child: Transform.translate(
            offset: Offset(0, value.get(AniPros.translateY)), child: child),
      ),
    );
  }
}
